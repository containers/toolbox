...
@test "user: root in shadow(5) inside RHEL 8.10" {
  ...
  "$TOOLBOX" run --distro rhel --release 8.10 true
...
@test "user: $USER in passwd(5) inside RHEL 8.10" {
  ...
  run --keep-empty-lines --separate-stderr "$TOOLBOX" run --distro rhel --release 8.10 cat /etc/passwd
...
@test "user: $USER in group(5) inside RHEL 8.10" {
  run --keep-empty-lines --separate-stderr "$TOOLBOX" run --distro rhel --release 8.10 cat /etc/group
